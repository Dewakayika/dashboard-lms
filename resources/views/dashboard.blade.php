          ...
          <div class="row">
            <div class="col-8">
              ...
              <div class="numbers mt-4">
                ...
                <p class="text-sm mb-0 text-white text-capitalize font-weight-light">Total Chapter</p>
              </div>
            </div>
      ...
      <div class="card">
        <div class="card-body bg-secondary p-3 border-radius-xl">
          <div class="row">
            <div class="col-8">
                <div class="icon icon-shape bg-white shadow text-center border-radius-section">
                    <i class="fa-solid fa-book fa-xl" style="color: #27272a;"></i>
                  </div>
              <div class="numbers mt-4">
                <h5 class="font-weight-bolder text-white mb-0">
                    2,300
                  </h5>
                <p class="text-sm mb-0 text-capitalize text-white font-weight-light">Today's Users</p>
              </div>
            </div>
          </div>
        </div>
