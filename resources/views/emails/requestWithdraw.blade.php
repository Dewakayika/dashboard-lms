...
<head>
  ...
  <title>Padma Creative Studio - Request Withdraw</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <div class="content">
        <p>Dear {{ $data['name'] }}, New ewallet requested!</p>

        <p>New ewallet just requested, please check your dashboard to approved</p>
