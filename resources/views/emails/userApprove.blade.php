...
<head>
  ...
  <title>Padma Creative Studio - Approve</title>
  <style>
...
<body>
  <div class="email-container">
    ...
    <div class="content">
      ...
      <p>Dear, {{$user->name}}</p>
      <p> <span class="bold">Congratulations!🎉</span> Welcome to the Team!</p>

      <p>Congratulations! Your account has been approved.
        We're excited to have you join our talented community.</p>

        <p>Login in our dashboard <a href="padmastudio.io">Padma Studio</a> to start working on project!</p>
