            ...
            @foreach ($orderData as $order)
                <div
                    ...
                    <div class="row align-items-center">
                        ...
                        @else
                            <br>
                            <button class="btn btn-primary px-5" data-bs-toggle="modal" data-bs-target="#orderModal"
                                data-bs-whatever="{{ $order->users->name }}" data-id="{{ $order->id }}"
                                data>Action</button>
                        @endif
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('driver#updateOrder') }}" method="get">
                        <div class="">
