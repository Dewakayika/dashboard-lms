...
@extends('users.CompanyAdmin.layouts.auth')
...
@section('content')
    ...
    <div class="col-12 mx-0">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item text-xs"><a href="{{ route('company#index') }}">Home</a></li>
                <li class="breadcrumb-item text-xs"><a href="{{ route('company#index') }}">Company Dashboard</a></li>
