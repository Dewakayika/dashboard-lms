        ...
        <div class="flex flex-col md:flex-row h-screen">
                        ...
                        <ul id="sidebarMenu" class="space-y-2">
                            <li>
                                <button class="dropdown-button flex items-center p-2 rounded hover:bg-gray-100 w-full" aria-expanded="false" data-target="dropdownMenu1">
                                    <span class="font-bold">1. Intro</span>
                                ...
                                <ul id="dropdownMenu1" class="pl-3 space-y-2 hidden gap-3 py-2">                                        
                                    ...
                                    <li>
                                        <a href="#" class="video-link flex items-center p-2 rounded hover:bg-gray-100" data-video="workflow">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span>Flashback Webtoon Workflow</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <button class="dropdown-button flex items-center p-2 rounded hover:bg-gray-100 w-full" aria-expanded="false" data-target="dropdownMenu2">
                                    <span class="font-bold">2. Practise</span>
                                    <svg class="ml-auto transition-transform transform dropdown-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 20px;">
                                        <path stroke-linecap="round" stroke-linejoin="round"  stroke-width="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
                                <ul id="dropdownMenu2" class="pl-3 space-y-2 hidden gap-3 py-2">                                        
                                    <li>
                                        <a href="#" class="video-link flex items-center p-2 rounded hover:bg-gray-100" data-video="sketchup">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span>Adjustment Angle Sketchup</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="video-link flex items-center p-2 rounded hover:bg-gray-100" data-video="panel-photoshop">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span>Panel Placing Photoshop</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li>
                                <button class="dropdown-button flex items-center p-2 rounded hover:bg-gray-100 w-full" aria-expanded="false" data-target="dropdownMenu13">
                                    <span class="font-bold">3. Assignment</span>
                                    <svg class="ml-auto transition-transform transform dropdown-icon" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="width: 20px;">
                                        <path stroke-linecap="round" stroke-linejoin="round"  stroke-width="2" d="M19 9l-7 7-7-7" />
                                    </svg>
                                </button>
            ...
            <main class="flex-1 p-4 md:p-8 overflow-y-auto">
                <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                    <h1 class="text-2xl font-bold mb-2">Advance Tool Webtoon Background</h1>
                </header>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateVideo(videoId) {
                    ...
                    switch(videoId) {
                        case 'introduction':
                            videoUrl = 'https://drive.google.com/file/d/1bsevJIUeIRNASiADTExVeO5_m0u-wktt/preview';
                            title = 'Introduction';
                            overviewContent = `
                                <span class="overview-title">Duration: 1:16 minute | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the webtoon background design process from start to finish. The material provided is based on the work that has been completed by the design team at Padma Creative Studio for the webtoon partner in Japan, namely VivionJp. The speaker will provide tips and tricks in the process of creating a webtoon background using Photoshop and Sketchup.</span>
                            `;
                            document.getElementById('submission').style.display = 'none';
                            break;
                        case 'workflow':
                            videoUrl = 'https://drive.google.com/file/d/1SjxtJ1VGxL6ExnyVlwMSyVF9OopwECMQ/preview';
                            title = 'Flashback webtoon background work flow';
                            overviewContent = `
                                <span class="overview-title">Duration: 3:08 minute | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the webtoon background design process from start to finish. The material provided is based on the work that has been completed by the design team at Padma Creative Studio for the webtoon partner in Japan, namely VivionJp. The speaker will provide tips and tricks in the process of creating a webtoon background using Photoshop and Sketchup.</span>
                                <span>Skills Covered: Practise advance webtoon background in sketchup and photoshop</span>
                            `;
                            document.getElementById('submission').style.display = 'none';
                            break;
                        case 'sketchup':
                            videoUrl = 'https://drive.google.com/file/d/1EIKf3ZlAsze5HxObXCuAdoGSsNBX2kIY/preview';
                            title = 'Adjusting Angle in Sketchup';
                            overviewContent = `
                                <span class="overview-title">Duration: 45:14 seconds | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the webtoon background design process from start to finish. The material provided is based on the work that has been completed by the design team at Padma Creative Studio for the webtoon partner in Japan, namely VivionJp. The speaker will provide tips and tricks in the process of creating a webtoon background using Photoshop and Sketchup.</span>
                                <span>Skills Covered: Practise advance webtoon background in sketchup and photoshop</span>
                            `;
                            document.getElementById('submission').style.display = 'none';
                            break;
                        case 'panel-photoshop':
                            videoUrl = 'https://drive.google.com/file/d/1xRJghp1_K3YymtnL6VfiSY7mUQOyQWU2/preview';
                            title = 'Panel placing in Photoshop';
                            overviewContent = `
                                <span class="overview-title">Duration: 22:44 minute | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the webtoon background design process from start to finish. The material provided is based on the work that has been completed by the design team at Padma Creative Studio for the webtoon partner in Japan, namely VivionJp. The speaker will provide tips and tricks in the process of creating a webtoon background using Photoshop and Sketchup.</span>
                                <span>Skills Covered: Practise advance webtoon background in sketchup and photoshop</span>
                            `;
