...
@section('title')
    Course | Standard Industry Practise
@endsection
        ...
        <div class="flex flex-col md:flex-row h-screen">
                        ...
                        <ul id="sidebarMenu" class="space-y-2">
                            <li>
                                <button class="dropdown-button flex items-center p-2 rounded hover:bg-gray-100 w-full" aria-expanded="false" data-target="dropdownMenu1">
                                    <span class="font-bold">Industry Practise</span>
                                ...
                                <ul id="dropdownMenu1" class="pl-3 space-y-2 hidden gap-3 py-2">                                        
                                    ...
                                    <li>
                                        <a href="#" class="video-link flex items-center p-2 rounded hover:bg-gray-100" data-video="general-standard">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <li>
                                        <a href="#" class="video-link flex items-center p-2 rounded hover:bg-gray-100" data-video="sketchup-standard">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span>Sketchup Standard</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#" class="video-link flex items-center p-2 rounded hover:bg-gray-100" data-video="photoshop-drive">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z" />
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                            <span>Photoshop & Drive Standard</span>
                                        </a>
                                    </li>
                                </ul>
                            </li>
            ...
            <main class="flex-1 p-4 md:p-8 overflow-y-auto">
                <header class="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                    <h1 class="text-2xl font-bold mb-2">Standard Industry Practise</h1>
                </header>
                ...
                <p class="text-sm font-regular text-gray-600 mt-2 text-justify">
                    ...
                    <br>
                    Silakan download file PSD dan Sketchup pada link material kemudian kerjakan sebuah judul yang telah kami berikan di folder yang berjudul <strong>Assignment Chapter 5</strong>.
                    <br>
                    Submission file PSD, Sketchup, dan PNG yang telah selesai di upload ke drive kemudian submit link drive pada submission dibawah! Jangan Lupa untuk menggunakan standard yang telah kami berikan di video!
                </p>              
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                function updateVideo(videoId) {
                    ...
                    switch(videoId) {
                        case 'introduction':
                            videoUrl = 'https://drive.google.com/file/d/1Q-vCNJ724vZ5m4vnHrxVqmNRETT-0BC6/preview';
                            title = 'Introduction';
                            overviewContent = `
                                <span class="overview-title">Duration: 1:18 minute | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the standard industry practise for Webtoon background design</span>
                            `;
                            document.getElementById('submission').style.display = 'none';
                            break;
                        case 'general-standard':
                            videoUrl = 'https://drive.google.com/file/d/14hPj0-kQBF39fLo3hqE_Hho7Qh99k-4_/preview';
                            title = 'General Standard';
                            overviewContent = `
                                <span class="overview-title">Duration: 1:19 minute | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the standard industry practise for Webtoon background design</span>
                            `;
                            document.getElementById('submission').style.display = 'none';
                            break;
                        case 'sketchup-standard':
                            videoUrl = 'https://drive.google.com/file/d/1tvwNahb4uqFciITCfCStQhqciH0q35Cu/preview';
                            title = 'Sketchup Standard';
                            overviewContent = `
                                <span class="overview-title">Duration: 21:32 seconds | Beginner</span>
                                <hr>
                                <span>In this course you will learn more details and complete in the standard industry practise for Webtoon background design</span>
                            `;
                            document.getElementById('submission').style.display = 'none';
                            break;
                        case 'photoshop-drive':
                            videoUrl = 'https://drive.google.com/file/d/1E-rWA2MNE4hFpBIn_q_lSV3xp2nQdLIK/preview';
                            title = 'Photoshop & Drive Standard';
                            overviewContent = `
