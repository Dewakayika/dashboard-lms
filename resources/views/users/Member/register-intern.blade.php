                        ...
                        <div class="space-y-5">
                            ...
                            <div class="flex items-center justify-center w-full">
                                <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed rounded-lg cursor-pointer bg-white hover:bg-gray-100 file-input-border">
                                    ...
                                    <input id="dropzone-file" type="file" name="profile_photo" class="hidden" required />
                                </label>
                                @error('profile_photo')
                            ...
                            <div>
                                ...
                                <div class="mt-2.5 relative">
                                    <select name="gender" id="gender" class="block w-full py-4 pl-3 pr-4 text-black transition-all duration-200 border border-gray-200 rounded-md bg-gray-50 focus:outline-none focus:caret-black-600 focus:bg-white caret-black-600 @error('gender') is-invalid @enderror" required>
