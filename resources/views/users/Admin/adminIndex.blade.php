                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-gray-50">
                                    <tr>
                                        ...
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase hidden">User ID</th>
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase">Username</th>
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase">Email</th>
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase">Total Submissions</th>
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase">Total Vote</th>
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase">Status</th>
                                        <th
                                            scope="col"
                                            class="px-6 py-3 text-start text-xs font-bold text-gray-500 uppercase">Action</th>
                                    </tr>
                                </thead>
                                <tbody class="divide-y divide-gray-200">
                                    @foreach($leaderboard as $user)
                                    <tr>
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-800">{{ ($leaderboard->currentPage() - 1) * $leaderboard->perPage() + $loop->iteration }}</td>
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-800 hidden">{{ $user->id }}</td>
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-800">
                                            ...
                                            <span
                                                class="text-green-500 p-2 bg-green-100 text-xs "
                                                style="border-radius: 50px">Completed</span>
                                            @else
                                        ...
                                        <td class="px-6 py-3 whitespace-nowrap text-sm text-gray-800">
                                            <a
                                                href="{{ route('admin.user.submissions', ['id' => Crypt::encrypt($user->id)]) }}"
                                                class="text-blue-600 hover:text-blue-800">
                                                <i class="fa-solid fa-folder-open text-blue-600 hover:text-blue-800"></i>
                                                Detail
                                            </a>
                                        </td>
                                    </tr>
