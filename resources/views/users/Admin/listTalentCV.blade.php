                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach ($talentCV as $CV)
                                    <tr>
                                        <td class="px-6 py-2 text-xs whitespace-nowrap text-xs font-medium text-gray-800">
                                            {{ ($talentCV->currentPage() - 1) * $talentCV->perPage() + $loop->iteration }}
                                        </td>
                                        <td class="px-6 py-2 text-xs whitespace-nowrap text-xs text-gray-800 hidden">{{ $CV->id }}</td>
                                        <td class="px-6 py-2 text-xs whitespace-nowrap text-xs text-gray-800">{{ $CV->name }}</td>
                                        <td class="px-6 py-2 text-xs whitespace-nowrap text-xs text-gray-800">{{ $CV->email }}</td>
                                        <td class="px-6 py-2 text-xs whitespace-nowrap text-xs text-gray-800">{{ $CV->phone_number }}</td>
