  ...
  <div class="row">
            ...
            <div class="card-body position-relative z-index-1 p-3">
              ...
              <div class="d-flex">
                ...
                <div class="ms-auto w-20 d-flex align-items-end justify-content-end">
                    ...
                    @else
                        <button class="badge badge-xs bg-secondary text-xs font-weight-bold mb-0 text-white" disabled style="border: none;">
                            <span class="px-2">Request Withdraw</span>
                        </button>
                    @endif
                </div>
    ...
    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
        <div class="card">
          ...
          <div class="card-body pt-0 p-3 text-center">
            <h6 class="text-center mb-0">Base Panel Compensation</h6>
    ...
    <div class="col-xl-2 col-sm-6 mb-xl-0 mb-4">
        <div class="card">
          ...
          <div class="card-body pt-0 p-3 text-center">
            <h6 class="text-center mb-0">Total Projects</h6>
            <span class="text-xs">Recap by this month</span>
            <hr class="horizontal dark my-3">
            <h5 class="mb-0">{{$recapProject}}</h5>
          </div>
        </div>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="px-3 pt-3">
                        <form action="{{ route('talentqc#withdrawRequest') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="hidden" name="total_panel" value="{{$totalPanelRecap}}">
