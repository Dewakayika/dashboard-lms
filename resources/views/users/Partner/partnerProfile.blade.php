                    ...
                    <div class="card shadow  mb-5 bg-white rounded">
                        <div class="rounded-top text-white d-flex flex-row" style="background-color: #fcc404; height:200px;">
                            <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                ...
                                <a href="{{ route('partner#editProfile') }}" type="button" class="btn btn-warning"
                        ...
                        <div class="p-4 text-black" style="background-color: #f8f9fa;">
                            <div class="d-flex justify-content-end text-center py-1">
                                <div>
                                    <p class="mb-1 h5"></p>
                                    <p class="small text-muted mb-0"><i class="fa fa-phone" aria-hidden="true"></i>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="p-4" style="background-color: #f8f9fa;">
                                    ...
                                    @if ($userData->users->gender == 1)
                                        <p class="font-italic mb-1"><i class="fa-solid fa-venus"></i>
                                            &nbsp; Female</p>
                                    @else
                                        <p class="font-italic mb-1"><i class="fa-solid fa-mars"></i>
                                            &nbsp; Male</p>
                                    @endif
                                    <p class="font-italic mb-0"><i class="fa fa-address-book" aria-hidden="true"></i></i>
                                        &nbsp; {{ $userData->users->role }}</p>
                                </div>
                            </div>

                            <div class="mb-5">
                                <p class="lead fw-normal mb-1"><i class="fa fa-address-card-o" aria-hidden="true"></i>
                                    &nbsp; Partnership Information</p>
                                <div class="p-4" style="background-color: #f8f9fa;">
                                    <p class="font-italic mb-1"><i class="fa fa-user" aria-hidden="true"></i> &nbsp;
                                        {{ $userData->partner_organization }}</p>
                                    <p class="font-italic mb-1"><i class="fa fa-link" aria-hidden="true"></i> &nbsp;
                                        {{ $userData->partnership_timeline }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
