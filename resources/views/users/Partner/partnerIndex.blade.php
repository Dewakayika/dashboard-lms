        ...
        <!-- <div class="flex gap-4">
                        <div class="">
                            <a href="{{ route('partner#addMeal') }}">
                                <button type="button" class="bg-mow-red hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                                    id="details">
                                    Create New Meals</button></a>
                        </div>
                        <div class="">
                            <a href="{{ route('partner#addCampaign') }}">
                                <button type="button" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded"
                                    id="details">
                                    Create New Campaign</button></a>
                        </div>
                        {{-- <div class="">
                <a href="{{ route('partner#addDriver') }}">
                    <button type="button" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded"
                        id="details">
                        Create New Drivers</button></a>
            </div> --}}
                    </div> -->
