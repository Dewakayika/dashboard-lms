                        ...
                        <div x-data="{ open: false }" class="">
                            <div @click="open = !open" class="relative border-b-2 pb-1 border-transparent z-50"
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-100"
                                    ...
                                    class="absolute w-48 py-3 dark:bg-gray-800 bg-white -ml-4 rounded-md shadow border dark:border-transparent mt-2">
                                    <ul class="space-y-3 px-3 dark:text-white">
                                        ...
                                        <li class="font-medium">
                                                <a href="#"
                                                    ...
                                                    <form action="{{ route('logout') }}" method="post">
                                                        @csrf
                                                        <button type="submit" class="" style="button:focus"> 
                                                            Logout </button>
                                                    </form>
                                                </a>
                                        </li>
