...
var Swiper = function () {
    ...
    var D = {
        ...
        updateSlides: function () {
            ...
            P
                ...
                : e.grid && e
                    .grid
                    .unsetSlides();
            const I = "auto" === s.slidesPerView && s.breakpoints && Object
                .keys(
                    s.breakpoints
                )
                .filter((e => void 0 !== s.breakpoints[e].slidesPerView))
                .length > 0;
            for (let a = 0; a < p; a += 1) {
                let i;
                if (
            ...
            if (
                ...
                m = t,
                Math.floor(e.virtualSize - r) - Math.floor(m[m.length - 1]) > 1 && m.push(
                    e.virtualSize - r
                )
            }
            if (o && s.loop) {
        ...
        updateSlidesProgress: function (e) {
            ...
            a.forEach((e => {
                e
                    .classList
                    .remove(s.slideVisibleClass, s.slideFullyVisibleClass)
            })),
        ...
        updateSlidesClasses: function () {
            ...
            if (t.forEach((e => {
                ...
                n
                    ? (o = t.filter((e => e.column === i))[0], c = t.filter(
                        (e => e.column === i + 1)
                    )[0], d = t.filter((e => e.column === i - 1))[0])
                    : o = t[i];
            o && (
        ...
        updateClickedSlide: function (e, t) {
            ...
            !i && s.isElement && t && t.length > 1 && t.includes(e) && [...t.slice(t.indexOf(e) + 1, t.length)].forEach(
                (e => {
            ...
            if (i.params.loop) 
                if (i.virtual && i.params.virtual.enabled) 
                    ...
                    if (r) {
                        ...
                        e = i
                            .slides
                            .filter((e => 1 * e.getAttribute("data-swiper-slide-index") === t))[0]
                            .column
                    } else 
                        e = i.getSlideIndexByData(n);
                    const t = r
                            ? Math.ceil(i.slides.length / i.params.grid.rows)
                            : i.slides.length, {centeredSlides: s} = i.params;
                    ...
                    if (s && (l = l || e < Math.ceil(a / 2)), l) {
                        ...
                        i.loopFix({
                            direction: a,
                            slideTo: !0,
                            activeSlideIndex: "next" === a
                                ? e + 1
                                : e - t + 1,
                            slideRealIndex: "next" === a
                                ? i.realIndex
                                : void 0
                        })
                    }
                    if (r) {
                        ...
                        n = i
                            .slides
                            .filter((t => 1 * t.getAttribute("data-swiper-slide-index") === e))[0]
                            .column
                    } else 
    ...
    var X = {
        loopCreate: function (e) {
            ...
            if (l) {
                if (s.loopAddBlankSlides) {
                    ...
                    g(
                        "Swiper Loop Warning: The number of slides is not even to slidesPerGroup, loop " +
                        "mode may not function properly. You need to add more slides (or make duplicate" +
                        "s, or empty slides)"
                    );
                i()
            } else if (o) {
                if (s.loopAddBlankSlides) {
                    ...
                    g(
                        "Swiper Loop Warning: The number of slides is not even to grid.rows, loop mode " +
                        "may not function properly. You need to add more slides (or make duplicates, or" +
                        " empty slides)"
                    );
                i()
            } else 
        ...
        loopFix: function (e) {
            ...
            d.length < f + w
                ? g(
                    "Swiper Loop Warning: The number of slides is not enough for loop mode, it will" +
                    " be disabled and not function properly. You need to add more slides (or make d" +
                    "uplicates) or lower the values of slidesPerView and slidesPerGroup parameters"
                )
                : b && "row" === m.grid.fill && g(
            ...
            let M = 0,
                C = 0;
            const P = b
                    ? Math.ceil(d.length / m.grid.rows)
                    : d.length,
                L = (
                    b
                        ? d[r].column
            ...
            if (
                ...
                "auto" === m.slidesPerView
                    ? o.updateSlides()
                    : b && (y.length > 0 && T || E.length > 0 && S) && o.slides.forEach(
                        ((e, t) => {
                            o
                                .grid
                                .updateSlide(t, e, o.slides)
                        })
                    ),
    ...
    function Y(e, t, s) {
        const a = r(), {params: i} = e,
            n = i.edgeSwipeDetection,
            l = i.edgeSwipeThreshold;
        return !n || !(s <= l || s >= a.innerWidth - l) || "prevent" === n && (
            t.preventDefault(),
            !0
        )
    }
    function B(e) {
        ...
        if ("pointerdown" === i.type) {
            ...
            "touchstart" === i.type && 1 === i.targetTouches.length && (
        ...
        s.activeElement && s
            .activeElement
            .matches(n.focusableElements) && s.activeElement !== p && s
            .activeElement
            .blur();
        const b = w && t.allowTouchMove && l.touchStartPreventDefault;
        !l.touchStartForcePreventDefault && !b || p.isContentEditable || i.preventDefault(),
        l.freeMode && l.freeMode.enabled && t.freeMode && t.animating && !l.cssMode && t
            .freeMode
            .onTouchStart(),
        t.emit("touchStart", i)
    }
    function R(e) {
        ...
        let g = s.isHorizontal()
                ? h
                : f,
            v = s.isHorizontal()
                ? n.currentX - n.previousX
                : n.currentY - n.previousY;
        r.oneWayMovement && (g = Math.abs(g) * (
            l
                ? 1
                : -1
        ), v = Math.abs(v) * (
        ...
        s.swipeDirection = g > 0
            ? "prev"
            : "next",
        s.touchesDirection = v > 0
            ? "prev"
            : "next";
        ...
        if (
            ...
            g > 0
                ? (b && y && i.allowThresholdMove && i.currentTranslate > (
                    ...
                    E = !1,
                    r.resistance && (i.currentTranslate = s.minTranslate() - 1 + (-s.minTranslate() + i.startTranslate + g) ** x)
                ))
    ...
    function q(e) {
        ...
        r.grabCursor && s.isMoved && s.isTouched && (
        ...
        for (
            let e = 0; e < c.length; e += e < r.slidesPerGroupSkip
                ? 1
                : r.slidesPerGroup
        ) {
            const t = e < r.slidesPerGroupSkip - 1
                ? 1
                : r.slidesPerGroup;
            void 0 !== c[e + t]
            ...
            transition: {
                setTransition: function (e, t) {
                    ...
                    s.params.cssMode || (
                        ...
                        s.wrapperEl.style.transitionDelay = 0 === e
                            ? "0ms"
                            : ""
                    ),
    ...
    class te {
        ...
        mount(e) {
            ...
            if ("string" == typeof s && (s = document.querySelector(s)), !s) 
                return !1;
            s.swiper = t,
            s.parentNode && s.parentNode.host && s.parentNode.host.nodeName === t
                .params
                .swiperElementNodeName
                .toUpperCase() && (t.isElement = !0);
    ...
    const me = [
        function (e) {
                    ...
                    for (let e = c; e <= p; e += 1) 
                        if (e < y || e > E) {
                            ...
                            s
                                .slides
                                .filter(
                                    (e => e.matches(`.${s.params.slideClass}[data-swiper-slide-index="${t}"], swiper-slide[data-swiper-slide-index="${t}"]`))
                                )
                                .forEach((e => {
                                    e.remove()
                                }))
            ...
            r("init update resize", (() => {
                s.params.virtual.enabled && s.params.cssMode && u(
                    s.wrapperEl,
                    "--swiper-virtual-size",
                    `${s.virtualSize}px`
                )
        ...
        function (e) {
            ...
            function f(e) {
                return !(
                    ...
                    !(t.params.mousewheel.thresholdTime && o() - p < t.params.mousewheel.thresholdTime) && (e.delta >= 6 && o() - p < 60 || (
                        e.direction < 0
        ...
        function (e) {
            ...
            function c(e) {
                const s = e
                    .target
                    .closest(ae(t.params.pagination.bulletClass));
                if (!s) 
                    return;
                e.preventDefault();
            ...
            function u() {
                ...
                a.forEach((s => {
                    ...
                    "bullets" === e.type && t
                        .pagination
                        .bullets
                        .push(...s.querySelectorAll(ae(e.bulletClass)))
                })),
            ...
            a("enable disable", (() => {
                ...
                e && (e = T(e), e.forEach((e => e.classList[
                    t.enabled
                        ? "remove"
                        : "add"
        ...
        function (e) {
            ...
            function b() {
                ...
                p = t.isHorizontal()
                    ? a.offsetWidth
                    : a.offsetHeight,
                u = t.size / (t.virtualSize + t.params.slidesOffsetBefore - (
                    t.params.centeredSlides
                        ? t.snapGrid[0]
                        : 0
                )),
                c = "auto" === t.params.scrollbar.dragSize
                    ? p * u
            ...
            const I = () => {
                t
                    .el
                    .classList
                    .add(...n(t.params.scrollbar.scrollbarDisabledClass)),
                t.scrollbar.el && t
                    .scrollbar
                    .el
                    .classList
            ...
            Object.assign(t.scrollbar, {
                enable: () => {
                    t
                        .el
                        .classList
                        .remove(...n(t.params.scrollbar.scrollbarDisabledClass)),
                    t.scrollbar.el && t
                        .scrollbar
                        .el
                        .classList
        ...
        function (e) {
            ...
            const i = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [d" +
        ...
        function (e) {
            ...
            function y() {
                const e = t.params.zoom,
                    s = m
                        .imageWrapEl
                        .getAttribute("data-swiper-zoom") || e.maxRatio;
            ...
            function T(e) {
                ...
                i >= 0 && (u[i] = e),
                u.length < 2 || (o = !0, m.scaleMove = b(), m.imageEl && (
            ...
            function C(e) {
                ...
                h.maxY = -h.minY,
                h.touchesCurrent.x = u.length > 0
                    ? u[0].pageX
                    : e.pageX,
                h.touchesCurrent.y = u.length > 0
                    ? u[0].pageY
                    : e.pageY;
                if (Math.max(
                ...
                h.currentX = h.touchesCurrent.x - h.touchesStart.x + h.startX + r * (
                    h.width - 2 * n
                ),
                h.currentY = h.touchesCurrent.y - h.touchesStart.y + h.startY + r * (
                    h.height - 2 * l
                ),
                h.currentX < h.minX && (
                    h.currentX = h.minX + 1 - (h.minX - h.currentX + 1) ** .8
                ),
                h.currentX > h.maxX && (
                    h.currentX = h.maxX - 1 + (h.currentX - h.maxX + 1) ** .8
                ),
                h.currentY < h.minY && (
                    h.currentY = h.minY + 1 - (h.minY - h.currentY + 1) ** .8
                ),
                h.currentY > h.maxY && (
                    h.currentY = h.maxY - 1 + (h.currentY - h.maxY + 1) ** .8
                ),
            ...
            function $() {
                ...
                t
                    .wrapperEl
                    .addEventListener("pointerdown", S, s),
                t
                    .wrapperEl
                    .addEventListener("pointermove", T, a),
                ["pointerup", "pointercancel", "pointerout"].forEach((e => {
                    t
                        .wrapperEl
                        .addEventListener(e, M, s)
                })),
                t
                    .wrapperEl
                    .addEventListener("pointermove", C, a)
            }
            function k() {
                const e = t.zoom;
                if (!e.enabled) 
                ...
                t
                    .wrapperEl
                    .removeEventListener("pointerdown", S, s),
                t
                    .wrapperEl
                    .removeEventListener("pointermove", T, a),
                ["pointerup", "pointercancel", "pointerout"].forEach((e => {
                    t
                        .wrapperEl
                        .removeEventListener(e, M, s)
                })),
                t
                    .wrapperEl
                    .removeEventListener("pointermove", C, a)
            }
            ...
            Object.assign(t.controller, {
                ...
                setTransition: function (e, s) {
                    ...
                    function n(s) {
                        s.destroyed || (
                            s.setTransition(e, t),
                            0 !== e && (s.transitionStart(), s.params.autoHeight && l((() => {
                                s.updateAutoHeight()
                            })), x(s.wrapperEl, (() => {
                                i && s.transitionEnd()
                            })))
        ...
        function (e) {
            ...
            function m(e) {
                ...
                t.pagination && t.pagination.el && (
                    ...
                    .target
                    .matches(ae(t.params.pagination.bulletClass)) || (
            ...
            const g = (e, t, s) => {
                ...
                S = () => {
                    ...
                    t
                        .el
                        .addEventListener("focus", E, !0),
                    t
                        .el
                        .addEventListener("pointerdown", w, !0),
                    t
                        .el
                        .addEventListener("pointerup", b, !0)
                };
            a("beforeInit", (() => {
                    ...
                    h() && t
                        ...
                        .forEach((s => {
                            t.params.pagination.clickable && (
                                n(s),
                                t.params.pagination.renderBullet || (o(s, "button"), c(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, y(s) + 1)))
                            ),
            ...
            a("destroy", (() => {
                t.params.a11y.enabled && function () {
                    ...
                    t
                        .el
                        .removeEventListener("focus", E, !0),
                    t
                        .el
                        .removeEventListener("pointerdown", w, !0),
                    t
                        .el
                        .removeEventListener("pointerup", b, !0)
                }()
            }))
        },
        function (e) {
            ...
            const l = e => e
                ...
                d = (e, s) => {
                    ...
                    const o = t.virtual && t.params.virtual.enabled
                        ? t
                            .slidesEl
                            .querySelector(`[data-swiper-slide-index="${s}"]`)
                        : t.slides[s];
        ...
        function (e) {
                ...
                M = (e, s) => {
                    ...
                    const a = () => {
                        ...
                        i.params.autoplay.waitForTransition
                            ? i
                                .wrapperEl
                                .addEventListener("transitionend", y)
                            : C()
                    };
            ...
            n("destroy", (() => {
                i
                    .el
                    .removeEventListener("pointerenter", L),
                i
                    .el
                    .removeEventListener("pointerleave", I),
        ...
        function (e) {
            ...
            r.grid = {
                ...
                updateSlide: (e, i, n) => {
                    ...
                    i.style[r.getDirectionLabel("margin-top")] = 0 !== f
                        ? d && `${d}px`
                        : "",
        ...
        function (e) {
            ...
            const i = (e, t, s) => {
                ...
                a || (a = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (
                    s
                        ? "left"
                        : "top"
                )).split(" ")), e.append(a)),
                i || (i = v("div", ("swiper-slide-shadow-cube swiper-slide-shadow-" + (
                    s
                        ? "right"
                        : "bottom"
                )).split(" ")), e.append(i)),
                ...
                setTranslate: () => {
                    ...
                    for (let e = 0; e < a.length; e += 1) {
                        ...
                        const w = `rotateX(${p
                            ...
                            : -n}deg) rotateY(${p
                                ? n
                                : 0}deg) translate3d(${f}px, ${g}px, ${v}px)`;
                        m <= 1 && m > -1 && (
                            h = 90 * r + 90 * m,
                            l && (h = 90 * -r - 90 * m),
                    ...
                    s
                        .style
                        .setProperty("--swiper-cube-translate-z", `${f}px`)
                },
                setTransition: e => {
