...
class MemberController extends Controller
{
    ...
    {
        $meal_data = Meal::with('ratings')->get();
        ...
        return view('users.Member.memberIndex')->with(['mealData' => $meal_data, 'memberData' => $member_data, 'dateCount' => $dateCount, 'userData' => $user]);;
    }
